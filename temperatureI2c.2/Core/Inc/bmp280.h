...
typedef enum {
    ...
    BMP280_STANDBY_250 = 3,     /* stand by time 250ms */ // koristimo ovo pripravno vrijeme
...
typedef struct {
    ...
    BMP280_Oversampling oversampling_temperature;// koristimo samo za temperaturu
...
} BMP280_HandleTypedef; /*Struktura*/
